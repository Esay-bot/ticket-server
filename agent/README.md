...
| 真实首轮(26 任务, DeepSeek) | 19/26 = 73.1% | 平均 2.08 轮/任务, 132,955 tokens |
| 真实复测(第 1 轮修复后) | **21/26 = 80.8%** | 平均 2.08 轮/任务, 159,397 tokens |
| 迭代说明 | — | 两轮共修 5 类根因(门控外反问/正则过严/Markdown 隔断/剧本用户无应变/未明说不存在); 演进: 73.1% → 80.8% |
